...
function insert_cart_info()
{
    ...
    return '<a href="flow.php" class="cart" title="' . $GLOBALS['_LANG']['view_cart'] . '">' . $str . '</a>';
}
...
{
    $sql = "SELECT salenum FROM " . $GLOBALS['ecs']->table('goods') . " WHERE is_on_sale =1 and goods_id  =".$arr['goods_id'] ;
